...
#Создание словаря для формирования различного способа ввода информации о Vlanах.
#Словарь создается до ввода информации

vlan_dict = {'access' : 'Введите номер VLAN: ', 'trunk' : 'Введите разрешенные VLANы:'}
...
interface_vlan = input(vlan_dict[interface_type])
